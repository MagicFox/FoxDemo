...
/**
 * Created by magicfox on 2017/5/27.
 */
public class DateUtils extends android.text.format.DateUtils {
     ...
     * 计算两个时间戳之间相差的时间戳数
     */
    public static long calculateDifference(long startTimeMillis, long endTimeMillis, @DateUtils.DifferenceMode int mode) {
     ...
     * 计算两个日期之间相差的时间戳数
     */
    public static long calculateDifference(Date startDate, Date endDate, @DateUtils.DifferenceMode int mode) {
    ...
    private static long[] calculateDifference(long differentMilliSeconds) {
        ...
        LogUtils.w(String.format(Locale.CHINA, "different: %d ms, %d days, %d hours, %d minutes, %d seconds",

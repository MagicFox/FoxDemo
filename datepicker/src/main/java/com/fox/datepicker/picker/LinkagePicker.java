...
import com.fox.datepicker.picker.entity.LinkageFirst;
import com.fox.datepicker.picker.entity.LinkageSecond;
import com.fox.datepicker.picker.entity.LinkageThird;
...
public class LinkagePicker<Fst extends LinkageFirst<Snd>, Snd extends LinkageSecond<Trd>, Trd> extends WheelPicker {
    ...
    protected LinkagePicker.Provider provider;
    ...
    private LinkagePicker.OnPickListener onPickListener;
    private LinkagePicker.OnLinkageListener onLinkageListener;
    ...
    public LinkagePicker(Activity activity, LinkagePicker.DataProvider provider) {
        super(activity);
        this.provider = provider;
    }

    public LinkagePicker(Activity activity, LinkagePicker.Provider<Fst, Snd, Trd> provider) {
        super(activity);
        this.provider = provider;
    }
     ...
     * 二级联动选择器构造函数
     *
     * @deprecated use {@link #LinkagePicker(Activity, LinkagePicker.Provider)} instead
     */
    @Deprecated
    ...
    public LinkagePicker(Activity activity, List<Fst> f, List<List<Snd>> s, List<List<List<Trd>>> t) {
        super(activity);
        this.provider = new LinkagePicker.DefaultDataProvider<>(f, s, t);
    }

    protected void setProvider(LinkagePicker.DataProvider provider) {
        this.provider = provider;
    }

    protected void setProvider(LinkagePicker.Provider<Fst, Snd, Trd> provider) {
        this.provider = provider;
    }
    ...
    public void setSelectedItem(Fst fst, Snd snd, Trd trd) {
        ...
        LogUtil.v("init select first: " + fst.getName() + ", index:" + selectedFirstIndex);
        //noinspection unchecked
        ...
        LogUtil.v("init select second: " + snd.getName() + ", index:" + selectedSecondIndex);
        ...
        LogUtil.v("init select third: " + trd + ", index:" + selectedThirdIndex);
    }
     ...
     * 设置完成选泽监听器
     */
    public void setOnPickListener(LinkagePicker.OnPickListener<Fst, Snd, Trd> onPickListener) {
     ...
     * 设置完成选泽监听器
     */
    public void setOnStringPickListener(LinkagePicker.OnStringPickListener onStringPickListener) {
    ...
    protected View makeCenterView() {
        ...
        firstView.setOnItemSelectListener(new WheelView.OnItemSelectListener() {
            ...
            public void onSelected(int index) {
                ...
                LogUtil.v("change second data after first wheeled");
        ...
        secondView.setOnItemSelectListener(new WheelView.OnItemSelectListener() {
            ...
            public void onSelected(int index) {
                ...
                if (!provider.isOnlyTwo()) {
                    LogUtil.v("change third data after second wheeled");
                    selectedThirdIndex = 0;//重置第三级索引
                    //noinspection unchecked
                    List<Trd> trds = provider.linkageThirdData(selectedFirstIndex, selectedSecondIndex);
                    selectedThirdItem = trds.get(selectedThirdIndex);
     ...
     * 数据选择完成监听器
     */
    public static abstract class OnStringPickListener implements LinkagePicker.OnPickListener<LinkagePicker.StringLinkageFirst, LinkagePicker.StringLinkageSecond, String> {

        public abstract void onPicked(String first, String second, String third);

        @Override
        public void onPicked(LinkagePicker.StringLinkageFirst first, LinkagePicker.StringLinkageSecond second, String third) {
     ...
     * 兼容旧版API
     *
     * @deprecated use {@link LinkagePicker.OnStringPickListener} instead
     */
    @Deprecated
    public static abstract class OnLinkageListener extends LinkagePicker.OnStringPickListener {
     ...
     * 兼容旧版API
     *
     * @deprecated use {@link LinkagePicker.OnWheelLinkageListener} instead
     */
    @Deprecated
    ...
    private static class StringLinkageFirst implements LinkageFirst<LinkagePicker.StringLinkageSecond> {
        private String name;
     ...
     * 兼容旧版API
     */
    public static abstract class DataProvider implements LinkagePicker.Provider<LinkagePicker.StringLinkageFirst, LinkagePicker.StringLinkageSecond, String> {
        ...
        public List<StringLinkageFirst> initFirstData() {
            ...
            int i = 0;
            for (String str : data) {
                firsts.add(new LinkagePicker.StringLinkageFirst(str, linkageSecondData(i)));
                i++;
            }
            return firsts;
        }
        ...
        public List<StringLinkageSecond> linkageSecondData(int firstIndex) {
            ...
            int i = 0;
            for (String str : data) {
                seconds.add(new LinkagePicker.StringLinkageSecond(str, linkageThirdData(firstIndex, i)));
                i++;
            }
            return seconds;
        }
     ...
     * 默认的数据提供者
     */
    private static class DefaultDataProvider<Fst extends LinkageFirst<Snd>, Snd extends LinkageSecond<Trd>, Trd> implements LinkagePicker.Provider<Fst, Snd, Trd> {

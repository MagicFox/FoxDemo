...
public class WheelView extends View {
    ...
    private WheelView.MessageHandler handler;
    private GestureDetector gestureDetector;
    private WheelView.OnItemSelectListener onItemSelectListener;
    private WheelView.OnWheelListener onWheelListener;
    ...
    public final void setOnItemSelectListener(WheelView.OnItemSelectListener onItemSelectListener) {
        this.onItemSelectListener = onItemSelectListener;
    }

    /**
     * @deprecated use {@link #setOnItemSelectListener(WheelView.OnItemSelectListener)} instead
     */
    @Deprecated
    public final void setOnWheelListener(WheelView.OnWheelListener listener) {
    ...
    public final void setItems(List<?> items) {
        ...
        for (Object item : items) {
            if (item instanceof WheelItem) {
                ...
                this.items.add(new WheelView.StringItem(item.toString()));
            } else {
    ...
    private void initView(Context context) {
        handler = new WheelView.MessageHandler(this);
    ...
    private void smoothScroll(int actionType) {
        ...
        WheelView.SmoothScrollTimerTask command = new WheelView.SmoothScrollTimerTask(this, offset);
    ...
    private void scrollBy(float velocityY) {
        cancelFuture();
        WheelView.InertiaTimerTask command = new WheelView.InertiaTimerTask(this, velocityY);
        mFuture = Executors.newSingleThreadScheduledExecutor()
    ...
    public static class DividerConfig {
         ...
         * 线是否可见
         */
        public WheelView.DividerConfig setVisible(boolean visible) {
         ...
         * 阴影是否可见
         */
        public WheelView.DividerConfig setShadowVisible(boolean shadowVisible) {
         ...
         * 阴影颜色
         */
        public WheelView.DividerConfig setShadowColor(@ColorInt int color) {
            shadowVisible = true;
            shadowColor = color;
            return this;
        }
         ...
         * 阴影透明度
         */
        public WheelView.DividerConfig setShadowAlpha(@IntRange(from = 1, to = 255) int alpha) {
         ...
         * 线颜色
         */
        public WheelView.DividerConfig setColor(@ColorInt int color) {
            this.color = color;
            return this;
        }
         ...
         * 线透明度
         */
        public WheelView.DividerConfig setAlpha(@IntRange(from = 1, to = 255) int alpha) {
            this.alpha = alpha;
            return this;
        }
         ...
         */
        public WheelView.DividerConfig setRatio(@FloatRange(from = 0, to = 1) float ratio) {
            this.ratio = ratio;
            return this;
        }
         ...
         * 线粗
         */
        public WheelView.DividerConfig setThick(float thick) {
            this.thick = thick;
            return this;
        }
     ...
     */
    @Deprecated
    public static class LineConfig extends WheelView.DividerConfig {
    }
     ...
     * 兼容旧版本API
     *
     * @deprecated use {@link WheelView.OnItemSelectListener} instead
     */
    @Deprecated
     ...
     */
    @Deprecated
    public interface OnWheelViewListener extends WheelView.OnWheelListener {
    }
    ...
    private static class SmoothScrollTimerTask extends TimerTask {
        ...
        public void run() {
            ...
            if (Math.abs(realTotalOffset) <= 1) {
                view.cancelFuture();
                view.handler.sendEmptyMessage(WheelView.MessageHandler.WHAT_ITEM_SELECTED);
            } else {
                ...
                view.handler.sendEmptyMessage(WheelView.MessageHandler.WHAT_INVALIDATE);
    ...
    private static class InertiaTimerTask extends TimerTask {
        ...
        public final void run() {
            ...
            if (Math.abs(a) >= 0.0F && Math.abs(a) <= 20F) {
                view.cancelFuture();
                view.handler.sendEmptyMessage(WheelView.MessageHandler.WHAT_SMOOTH_SCROLL);
                return;
            }

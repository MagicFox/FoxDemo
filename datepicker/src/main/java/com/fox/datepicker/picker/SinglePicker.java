...
public class SinglePicker<T> extends WheelPicker {
    ...
    private SinglePicker.OnWheelListener<T> onWheelListener;
     ...
     * 设置滑动过程监听器
     */
    public void setOnWheelListener(SinglePicker.OnWheelListener<T> onWheelListener) {
     ...
     * 设置确认选择监听器
     */
    public void setOnItemPickListener(SinglePicker.OnItemPickListener<T> listener) {

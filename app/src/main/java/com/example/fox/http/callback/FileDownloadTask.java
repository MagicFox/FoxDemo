...
import com.example.fox.http.OkHttpManager;
import com.example.fox.utils.FileUtils;
...
public class FileDownloadTask extends AsyncTask<Void, Long, Boolean> {
    ...
    private String url;
    private File target;
    //the time of start download，to computer download speed
    private long previousTime;
    public FileDownloadTask(String url, File target, FileDownloadCallback callback) {
        this.url = url;
        this.okHttpClient = OkHttpManager.getInstance().getDownloadClient();
